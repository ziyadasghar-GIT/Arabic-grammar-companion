...
const legendItems = [
  { arabic: "مرفوع", english: "Nominative", color: "bg-blue-50 text-blue-800 border-blue-300", dot: "bg-blue-600" },
  { arabic: "منصوب", english: "Accusative", color: "bg-red-50 text-red-800 border-red-300", dot: "bg-red-600" },
  { arabic: "مجرور", english: "Genitive", color: "bg-green-50 text-green-800 border-green-300", dot: "bg-green-600" },
  { arabic: "مبني", english: "Invariable", color: "bg-gray-50 text-gray-700 border-gray-300", dot: "bg-gray-600" },
];
